...
# MODIFICADO: Versión indica adición 'mt' (multi-tenant)
app = FastAPI(title="Asistente IA Ashotel API v2.3.7-mt (Tenant Handling)", version="2.3.7-mt")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
